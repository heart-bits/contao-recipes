...
$GLOBALS['TL_DCA']['tl_module']['palettes'][RecipeListController::TYPE] = '{title_legend},name,type;{source_legend},imgSize;{template_legend:hide},customTpl,navigationTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
